...
- Гарними кандидатами на оптимізацію є _Datapicker_, складні _Select_, _DataGrid_ та інші складні елементи, які вимагаються трохи більше часу ніж зазвичай для рендерингу.
